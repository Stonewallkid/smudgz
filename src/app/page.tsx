  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="min-h-[90vh] flex flex-col items-center justify-center px-4 relative overflow-hidden">
        {/* Background gradient */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#112d4e] via-[#0a192f] to-[#0a192f]" />
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-cyan-500/20 rounded-full blur-[128px]" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-pink-500/30 rounded-full blur-[128px]" />

        <div className="relative z-10 text-center max-w-4xl mx-auto">
          {/* Logo */}
          <img src="/logo-white.png" alt="Smudgz" className="h-28 md:h-40 mx-auto mb-8" />

          <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-cyan-200 to-pink-300 bg-clip-text text-transparent">
            Turn Any Webpage Into a Playground
          </h1>
          <p className="text-xl md:text-2xl text-cyan-100/80 mb-10 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="#demo"
              className="px-8 py-4 border border-cyan-400/30 rounded-full text-lg font-medium hover:bg-cyan-400/10 transition text-cyan-100"
            >
              Watch Demo
            </Link>
          </div>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
          <svg className="w-6 h-6 text-cyan-200/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* Features Section */}
      <section id="features" className="py-20 px-4 bg-gradient-to-b from-[#0a192f] via-[#0d2137] to-[#0a192f]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
            Everything You Need to Play
          </h2>
          <p className="text-cyan-200/60 text-center mb-16 max-w-2xl mx-auto">
            Smudgz packs multiplayer gaming, drawing tools, and annotations into one seamless experience.
          </p>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Feature 1 */}
            <div className="p-6 rounded-2xl bg-[#112d4e]/50 border border-cyan-400/10 hover:border-pink-500/50 transition">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-cyan-200/50 text-center mb-16 max-w-2xl mx-auto">
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-20 px-4 bg-gradient-to-b from-[#0a192f] via-[#0d2137] to-[#0a192f]">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
            Frequently Asked Questions
          </h2>
          <p className="text-cyan-200/50 text-center mb-12">
          ...
          <div className="space-y-4">
            <details className="group p-6 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="mt-4 text-cyan-200/50">
            ...
            <details className="group p-6 rounded-2xl bg-white/5 border border-white/10">
              ...
              <p className="mt-4 text-cyan-200/50">
                One player becomes &quot;it&quot; (marked with IT above their head). Tag another player by touching them. There&apos;s a 3-second cooldown to prevent immediate tag-backs. &quot;NO TAG BACKS&quot; flashes across the screen when someone gets tagged.
              </p>
            </details>
